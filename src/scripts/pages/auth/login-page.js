  ...
  async render() {
    return `
      <section style="background: linear-gradient(120deg, #fff8dc 40%, #ffecc1 100%);
        ...
        <h1 style="color:#f89700; font-weight:900; text-align:center; margin-bottom:26px;">Login</h1>
        <form id="login-form" style="display:flex; width: 250px; flex-direction:column; gap:16px;">
          ...
          <button type="submit" style="background-color: #ffba31; color: white; font-weight: 700; font-size: 1.1rem; border: none;
            border-radius: 10px; padding: 14px 0; cursor: pointer; box-shadow: 0 4px 14px rgba(255, 178, 49, 0.5);">Login</button>
        </form>
        <p style="text-align:center; margin-top:16px; font-size: 0.95rem;">
          Belum punya akun? <a href="#/register" style="color:#cc7f00; font-weight:600; text-decoration: underline;">Daftar</a><br />
          <a href="#/forgot" style="color:#cc7f00; font-weight:600; text-decoration: underline;">Lupa Password?</a>
        </p>
      </section>
    `;
  },
